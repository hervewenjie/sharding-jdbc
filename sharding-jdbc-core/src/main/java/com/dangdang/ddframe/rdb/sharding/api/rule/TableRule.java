...
public final class TableRule {
    ...
    public static class TableRuleBuilder {
        ...
        private DatabaseShardingStrategy databaseShardingStrategy; // database
        
        private TableShardingStrategy tableShardingStrategy;       // table
        
        private String generateKeyColumn;                          // pk
        
        private Class<? extends KeyGenerator> keyGeneratorClass;   // pk generator
