...
//        dropTable(dataSource);
    ...
    private static ShardingDataSource getShardingDataSource() {
        ...
        // datasource rule is datasource maps
        ...
        ShardingRule shardingRule = ShardingRule
                ...
                // database sharding strategy key 'user_id'
                .databaseShardingStrategy(new DatabaseShardingStrategy("user_id", new ModuloDatabaseShardingAlgorithm()))
                // table sharding strategy key 'order_id'
    ...
    // create datasource based on dbcp
